within MicroGrid.Thermal_Power.Gas.GTArrangements;
model SingleShaftGT "Complete Single Shaft Gas Turbine Model From ThermoPower Library"
  ...
  parameter ThermoPower.AbsoluteTemperature comprTdes_in "Compressor inlet design temperature";
  parameter ThermoPower.AbsoluteTemperature turbTdes_in "Turbine inlet design temperature";
  parameter Modelica.Units.SI.AngularVelocity Ndesign "Design velocity";
  parameter Modelica.Units.SI.Volume V "Combustion Chamber Inner volume";
  parameter Modelica.Units.SI.Area S=0 "Combustion Chamber Inner surface";
  parameter Modelica.Units.SI.CoefficientOfHeatTransfer gamma=0 "Combustion Chamber Heat Transfer Coefficient";
  parameter Modelica.Units.SI.HeatCapacity Cm=0 "Combustion Chamber Metal Heat Capacity";
  parameter Modelica.Units.SI.SpecificEnthalpy HH "Lower Heating value of fuel";
  parameter Modelica.Units.SI.MassFlowRate pd1_wnom "Pre-combustion PressureDrop Nominal mass flowrate";
  parameter Modelica.Units.SI.MassFlowRate pd2_wnom "Post-combustion PressureDrop Nominal mass flowrate";
  parameter Modelica.Units.SI.Pressure dpnom1 "Pre-combustion nominal pressure drop";
  parameter Modelica.Units.SI.Pressure dpnom2 "Post-combustion nominal pressure drop";
  parameter ThermoPower.GasDensity pd1_rhonom=0 "Pre-combustion PressureDrop Nominal density";
  parameter ThermoPower.GasDensity pd2_rhonom=0 "Post-combustion PressureDrop Nominal density";
