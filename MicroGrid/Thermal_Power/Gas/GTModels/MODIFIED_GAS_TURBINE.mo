...
model MODIFIED_GAS_TURBINE "Model of gas turbine, compressor and combustor"
  import ThermalPower;
  package Medium_Fuel = ThermalPower.Media.Gases.NaturalGasWithH2;
  package Medium =ThermalPower.Media.Gases.MoistFlueGas;

  Modelon.Visualizers.RealValue realValue1(precision=0, number=turbine.summary.shaftSpeed
        *60/(2*3.14))
  ...
  Modelica.Mechanics.Rotational.Interfaces.Flange_b shaft_b1 annotation (
      Placement(transformation(extent={{138,-8},{158,12}}),
        iconTransformation(extent={{138,-8},{158,12}})));
equation
  ...
  connect(turbine.shaft_b, shaft_b1) annotation (Line(points={{46.08,12.32},
          {140,12.32},{140,2},{148,2}}, color={0,0,0}));
