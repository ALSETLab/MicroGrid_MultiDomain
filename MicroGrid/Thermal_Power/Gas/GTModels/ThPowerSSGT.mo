...
model ThPowerSSGT "Gas Turbine Dynamics based on ThermoPower Example Case"
  ...
  GTArrangements.SingleShaftGT gasTurbine(
    Ndesign=157.08,
    V=0.05,
    S=0.05,
    gamma=1,
    ...
    dpnom1=19000,
    dpnom2=26000)
    annotation (Placement(transformation(extent={{-58,-128},{68,0}})));
  ...
  Modelica.Blocks.Tables.CombiTable1Dv combiTable1D(smoothness=Modelica.Blocks.Types.Smoothness.LinearSegments, table=[0.15, 1.84968; 0.35, 2.0588; 0.55, 2.27026; 0.75, 2.48528; 0.816667, 2.55802])
...
Dynamics",textStyle={TextStyle.Bold}),
        ...
        Bitmap(
          ...
          fileName="modelica://CHP_MultiDomain/speedsensor.png"),
        Text(
