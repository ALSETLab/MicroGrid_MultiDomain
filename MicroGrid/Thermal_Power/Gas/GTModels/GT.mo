within MicroGrid.Thermal_Power.Gas.GTModels;
model GT "Gas Turbine Dynamics based on ThermoPower Example Case"
  ...
  ThermoPower.PowerPlants.Buses.Sensors SensorsBus annotation (
      Placement(transformation(extent={{180,-120},{220,-80}}, rotation=
            0), iconTransformation(extent={{180,-120},{220,-80}})));
  ...
  Gas.GTArrangements.SingleShaftGT                               gasTurbine(
    Ndesign=157.08,
    V=0.05,
    S=0.05,
    gamma=1,
  ...
  Modelica.Blocks.Interfaces.RealOutput PMECH "Mechanical Power (W)"
    annotation (Placement(transformation(extent={{160,-74},{190,-44}}), iconTransformation(
        ...
        rotation=-90,
        origin={-130,-206})));
  Modelica.Blocks.Interfaces.RealInput in_w1 annotation (Placement(
        transformation(extent={{-240,120},{-200,160}})));
equation
  ...
  connect(FuelSource.in_w0, in_w1) annotation (Line(points={{-65.6,66},
          {-110,66},{-110,140},{-220,140}}, color={0,0,127}));
