within MicroGrid.Thermal_Power.Gas.GTModels.Plants;
model GTPlant_ThPowerSSGT_NoLoad2 "ThermoPower Gas Turbine Plant Example without load, variable shaft speed"
  ...
  ThPowerSSGT gTDynamics
    annotation (Placement(transformation(extent={{-74,-24},{-34,16}})));
...
equation
  ...
  connect(valvePosition, gTDynamics.valvePosition) annotation (Line(points={{-106,20},
          {-88,20},{-88,5.5},{-74.3,5.5}},                                                                             color={0,0,127}));
  connect(gTDynamics.PMECH, Pmech) annotation (Line(points={{-67,-24.6},{-67,
          -44},{92,-44},{92,0},{146,0}},                                                                    color={0,0,127}));
