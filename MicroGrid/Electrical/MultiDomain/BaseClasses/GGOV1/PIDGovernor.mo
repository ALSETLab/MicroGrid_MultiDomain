...
model PIDGovernor "GE GGOV1 General Governor Frequency Controller"
  ...
  parameter OpenIPSL.Types.PerUnit Kpgov=10
    "Governor proportional gain";
  parameter OpenIPSL.Types.TimeAging Kigov=2
    "Governor integral gain";
  parameter OpenIPSL.Types.Time Kdgov=0
  ...
  parameter OpenIPSL.Types.TimeAging Kimw=0
    "Power controller (reset) gain";
  parameter OpenIPSL.Types.PerUnit db=0
  ...
  Modelica.Blocks.Nonlinear.DeadZone deadZone(uMax=db)
  ...
  R_select rSELECT(Rselect=Rselect) annotation (Placement(
        transformation(
        origin={-30,-24},
        extent={{-10,-10},{10,10}},
        rotation=90)));
...
protected
  ...
  parameter OpenIPSL.Types.PerUnit s20(fixed=false);
  parameter OpenIPSL.Types.PerUnit s70(fixed=false);
