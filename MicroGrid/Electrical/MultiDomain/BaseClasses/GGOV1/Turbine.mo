within MicroGrid.Electrical.MultiDomain.BaseClasses.GGOV1;
model Turbine "GE General GGOV1 and GGOV1DU Turbine Model"
  ...
  MicroGrid.Electrical.MultiDomain.BaseClasses.GGOV1.Flag flag10(Flag=
        Flag) annotation (Placement(transformation(extent={{-10,-10},{
            10,10}}, origin={-30,0})));
  MicroGrid.Electrical.MultiDomain.BaseClasses.GGOV1.Dm_select
    dm_select(Dm=Dm)
...
protected
  ...
  parameter OpenIPSL.Types.PerUnit s30(fixed=false);
  parameter OpenIPSL.Types.PerUnit s40(fixed=false);
  parameter OpenIPSL.Types.PerUnit s50(fixed=false);
  parameter OpenIPSL.Types.PerUnit s90(fixed=false);
...
equation
  ...
  connect(gain1.y, s4.u) annotation (Line(points={{89,-40},{126,
          -40}}, color={0,0,127}));
  annotation (
