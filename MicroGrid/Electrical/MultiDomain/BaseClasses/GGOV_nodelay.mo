within MicroGrid.Electrical.MultiDomain.BaseClasses;
model GGOV_nodelay
  ...
  parameter OpenIPSL.Types.PerUnit R=0.04 "Permanent droop";
  parameter OpenIPSL.Types.Time T_pelec=1
    "Electrical power transducer time constant";
  parameter OpenIPSL.Types.PerUnit maxerr=0.05
    "Maximum value for speed error signal";
  parameter OpenIPSL.Types.PerUnit minerr=-0.05
    "Minimum value for speed error signal";
  parameter OpenIPSL.Types.PerUnit Kpgov=10 "Governor proportional gain";
  parameter OpenIPSL.Types.TimeAging Kigov=2 "Governor integral gain";
  parameter OpenIPSL.Types.Time Kdgov=0 "Governor derivative gain";
  parameter OpenIPSL.Types.Time Tdgov=1
    "Governor derivative controller time constant";
  parameter OpenIPSL.Types.PerUnit Vmax=1 "Maximum valve position limit";
  parameter OpenIPSL.Types.PerUnit Vmin=0.15 "Minimum valve position limit";
  parameter OpenIPSL.Types.Time Tact=0.5 "Actuator time constant";
  parameter OpenIPSL.Types.PerUnit Kturb=1.5 "Turbine gain";
  parameter OpenIPSL.Types.PerUnit Wfnl=0.2 "No load fuel flow";
  parameter OpenIPSL.Types.Time Tb=0.1 "Turbine lag time constant";
  parameter OpenIPSL.Types.Time Tc=0 "Turbine lead time constant";
  parameter OpenIPSL.Types.Time Teng=0
    "Transport lag time constant for diesel engine";
  parameter OpenIPSL.Types.Time Tfload=3 "Load Limiter time constant";
  parameter OpenIPSL.Types.PerUnit Kpload=2
    "Load limiter proportional gain for PI controller";
  parameter OpenIPSL.Types.TimeAging Kiload=0.67
    "Load limiter integral gain for PI controller";
  parameter OpenIPSL.Types.PerUnit Ldref=1 "Load limiter reference value";
  parameter OpenIPSL.Types.PerUnit Dm=0 "Mechanical damping coefficient";
  parameter OpenIPSL.Types.TimeAging Ropen=0.1 "Maximum valve opening rate";
  parameter OpenIPSL.Types.TimeAging Rclose=-0.1 "Maximum valve closing rate";
  parameter OpenIPSL.Types.TimeAging Kimw=0 "Power controller (reset) gain";
  parameter OpenIPSL.Types.TimeAging Aset=0.1 "Acceleration limiter setpoint";
  parameter OpenIPSL.Types.PerUnit Ka=10 "Acceleration limiter gain";
  parameter OpenIPSL.Types.Time Ta=0.1 "Acceleration limiter time constant";
  parameter OpenIPSL.Types.ActivePower Trate=0 "Turbine rating";
  parameter OpenIPSL.Types.PerUnit db=0 "Speed governor deadband";
  parameter OpenIPSL.Types.Time Tsa=4
    "Temperature detection lead time constant";
  parameter OpenIPSL.Types.Time Tsb=5 "Temperature detection lag time constant";
  parameter OpenIPSL.Types.TimeAging Rup=99
    "Maximum rate of load limit increase";
  parameter OpenIPSL.Types.TimeAging Rdown=-99
    "Maximum rate of load limit decrease";
  parameter OpenIPSL.Types.Time DELT=0.005 "Time step used in simulation";
  ...
  Electrical.MultiDomain.BaseClasses.GGOV1.Turbine gGOV1_Turb(
    Tact=Tact,
    Kturb=Kturb,
    Tb=Tb,
    Tc=Tc,
    ...
    DELT=DELT,
    Flag=Flag,
    Wfnl=Wfnl) annotation (Placement(transformation(origin={82,2}, extent=
           {{-10,-10},{10,10}})));
...
protected
  ...
  parameter OpenIPSL.Types.PerUnit Pmwset(fixed=false);
  parameter OpenIPSL.Types.PerUnit fsr0(fixed=false);
...
equation
  connect(gGOV1_Turb.PMECH, PMECH) annotation (
    Line(points={{93,2},{102,2},{102,0},{110,0}},
                                       color = {0, 0, 127}));
  ...
  connect(V.y, gGOV1_Turb.FSR) annotation (
    Line(points={{55,0},{62,0},{62,2},{70,2}},
                                      color = {0, 0, 127}));
  ...
  connect(gGOV1_Temp.TEXM, gGOV1_Turb.TEXM) annotation (
    Line(points={{-18,84},{82,84},{82,13}},        color = {0, 0, 127}));
  connect(SPEED, gGOV1_Turb.SPEED) annotation (
    Line(points={{-120,60},{64,60},{64,10},{70,10}},        color = {0, 0, 127}));
  ...
  connect(PELEC, gGOV1_Turb.PELEC) annotation (
    Line(points={{-120,-60},{-80,-60},{-80,-90},{64,-90},{64,-8},
          {70,-8},{70,-6}},                                                                       color = {0, 0, 127}));
  connect(gGOV1_Turb.VSTROKE, gGOV1_Power.VSTROKE) annotation (
    Line(points={{93.2,-6},{96,-6},{96,-78},{-34,-78},{-34,-64}},                      color = {0, 0, 127}));
