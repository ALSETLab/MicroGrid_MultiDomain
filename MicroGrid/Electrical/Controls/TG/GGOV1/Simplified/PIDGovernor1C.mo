...
model PIDGovernor1C "GE General GGOV Governor Frequency Controller, PID Implementation 1C"
  ...
  Modelica.Blocks.Nonlinear.DeadZone deadZone(uMax=db) annotation (Placement(transformation(extent={{-20,-12},{0,8}})));
...
public
  Modelica.Blocks.Interfaces.RealInput PELEC "Machine electrical power (pu)"
    annotation (Placement(transformation(extent={{-182,-134},{-154,-106}}),iconTransformation(extent={{-168,-86},{-134,-52}})));
  Modelica.Blocks.Interfaces.RealInput SPEED "Machine speed deviation from nominal (pu)"
    annotation (Placement(transformation(extent={{-102,12},{-76,38}}), iconTransformation(extent={{-168,52},{-134,86}})));
  ...
  Modelica.Blocks.Sources.Constant P_ref(k=Pref) annotation (Placement(transformation(extent={{-140,-4},{-122,14}})));
initial equation
  Pe0 = PELEC;
  Pmech0 = PELEC;
  Pmwset = Pe0;
...
equation
  ...
  connect(s0.y, rSELECT.Pelect) annotation (Line(
      points={{-105,-98},{-69.6,-98},{-69.6,-77}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(rSELECT.y, r.u) annotation (Line(
      points={{-52,-42.5},{-51.72,-42.5},{-51.72,-37.4},{-53,-37.4}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(rSELECT.GovernorOutput, FSR) annotation (Line(points={{-34.4,
-77},{40,-77},{40,-80},{126,-80},{126,-62},{136,-62},{136,
76},{109,76},{109,103}},    color={0,0,127}));
  connect(add2.u1, r_.y) annotation (Line(points={{-85.2,1.6},{-92,1.6},{-92,5},{-97.3,5}}, color={0,0,127}));
  connect(Vstr_set.y, rSELECT.ValveStroke) annotation (Line(points={{5.1,
-101},{20,-101},{20,-77},{-52,-77}},color={0,0,127}));
  connect(P_ref.y, r_.u) annotation (Line(points={{-121.1,5},{-117.55,5},{-113.4,5}}, color={0,0,127}));
  annotation (
