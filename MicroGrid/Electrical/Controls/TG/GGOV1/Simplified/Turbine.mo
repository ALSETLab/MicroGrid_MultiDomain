...
model Turbine "GE General GGOV Turbine Model"
...
public
  ...
  Modelica.Blocks.Interfaces.RealOutput PMECH "Turbine mechanical power (pu)" annotation (Placement(transformation(extent={{116,50},{134,68}}), iconTransformation(extent={{140,-12},{164,12}})));
  ...
  Modelica.Blocks.Math.Product product1 annotation (Placement(transformation(
        ...
        rotation=180,
        origin={-46,124})));
  Modelica.Blocks.Interfaces.RealOutput TEXM "Measured Exhaust Temperature"
...
equation
  ...
  connect(flag10.y, product.u2) annotation (Line(
      points={{18,-95},{18,-59.6},{18.8,-59.6}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(dm_select.y, gain2.u) annotation (Line(
      points={{5,102},{12.4,102},{12.4,102}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(Dw2w.y, dm_select.speed) annotation (Line(points={{-87,22},
{-60,22},{-60,102},{-18,102}},    color={0,0,127}));
  connect(flag10.speed, dm_select.speed) annotation (Line(points={{18,-118},
{18,-130},{-120,-130},{-120,-20},{-60,-20},{-60,102},{-18,
102}},   color={0,0,127}));
  annotation (
