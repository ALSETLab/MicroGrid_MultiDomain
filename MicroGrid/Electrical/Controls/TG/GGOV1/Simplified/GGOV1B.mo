...
model GGOV1B "GE General Governor/Turbine Model without Load & Acceleration Limiters"
  ...
  Modelica.Blocks.Interfaces.RealInput SPEED "Machine speed deviation from nominal (pu)"
    annotation (Placement(transformation(extent={{-146,-4},{-108,34}}), iconTransformation(extent={{-188,72},{-150,110}})));
  Modelica.Blocks.Interfaces.RealInput PELEC "Machine electrical power (pu)" annotation (Placement(transformation(extent={{-146,-32},{-110,4}}), iconTransformation(extent={{-188,-90},{-150,-52}})));
  ...
  Turbine turb(
    ...
    DELT=DELT,
    Flag=0,
    Wfnl=Wfnl) annotation (Placement(transformation(extent={{40,-30},{100,30}})));
  PIDGovernor1C gov(
    R=R,
    T_pelec=T_pelec,
    maxerr=maxerr,
    ...
    Vmax=Vmax,
    Vmin=Vmin,
    Pref=Pref) annotation (Placement(transformation(extent={{-80,-30},{-20,30}})));
equation
  connect(gov.FSR, turb.FSR) annotation (Line(points={{-17.4286,0},{0,0},{0,
          -21.6429},{37.6429,-21.6429}},
                                     color={0,0,127}));
  connect(SPEED, gov.SPEED) annotation (Line(points={{-127,15},{-105.5,15},{
          -105.5,14.7857},{-82.3571,14.7857}},       color={0,0,127}));
  connect(turb.SPEED, gov.SPEED) annotation (Line(points={{37.8571,21.4286},{0,
          21.4286},{0,60},{-100,60},{-100,14.7857},{-82.3571,14.7857}},
                     color={0,0,127}));
  connect(PELEC, gov.PELEC) annotation (Line(points={{-128,-14},{-82.3571,-14},
          {-82.3571,-14.7857}},          color={0,0,127}));
  connect(turb.PELEC, gov.PELEC) annotation (Line(points={{38.0714,0.214286},{
          20,0.214286},{20,-60},{-100,-60},{-100,-14},{-82.3571,-14},{-82.3571,
          -14.7857}},                  color={0,0,127}));
  connect(turb.PMECH, PMECH) annotation (Line(points={{102.571,0},{102.571,1},{
          133,1}},          color={0,0,127}));
  annotation (
    Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-160,-140},{160,140}})),
    Icon(coordinateSystem(extent={{-160,-140},{160,140}}, preserveAspectRatio=false), graphics={Rectangle(extent={{-160,140},{160,-140}}, lineColor={0,0,255}),Text(
