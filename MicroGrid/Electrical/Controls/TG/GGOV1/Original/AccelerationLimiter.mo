...
model AccelerationLimiter "GE General GGOV Governor Acceleration Control"
...
public
  Modelica.Blocks.Interfaces.RealInput ASET "Acceleration limiter setpoint (p.u./s)"
    annotation (Placement(transformation(extent={{-124,32},{-92,64}}), iconTransformation(extent={{-118,38},{-92,64}})));
  Modelica.Blocks.Interfaces.RealOutput FSRA "Acceleration Controller Output" annotation (Placement(transformation(extent={{100,38},{122,60}}), iconTransformation(extent={{100,38},{122,60}})));
