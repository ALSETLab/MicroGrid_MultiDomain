...
public
  ...
  Modelica.Blocks.Interfaces.RealInput PMW_SET "Supervisory Load Controller Setpoint"
...
equation
  ...
  connect(VSTROKE, rSELECT.ValveStroke) annotation (Line(points={{-3,-93},
{-3,-41.8},{-52,-41.8},{-52,-61}},         color={0,0,127}));
