...
model LoadLimiter "GE General GGOV Governor/Turbine Temperature Control"
...
public
  ...
  Modelica.Blocks.Interfaces.RealInput LDREF "Load Limiter reference value (pu)" annotation (Placement(transformation(extent={{-78,6},{-50,34}}), iconTransformation(extent={{-124,-16},{-94,14}})));
  Modelica.Blocks.Interfaces.RealInput TEXM "Measured Exhaust Temperature" annotation (Placement(transformation(extent={{112,32},{90,54}}), iconTransformation(extent={{122,36},{94,64}})));
  Modelica.Blocks.Interfaces.RealInput WF "Fuel flow (Governor output)" annotation (Placement(transformation(extent={{86,-42},{62,-18}}), iconTransformation(extent={{120,-24},{92,4}})));
  Modelica.Blocks.Interfaces.RealInput PELEC "Machine electrical power (pu)" annotation (Placement(transformation(
        extent={{-15,-15},{15,15}},
        rotation=90,
