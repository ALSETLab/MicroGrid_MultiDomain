within MicroGrid.Electrical.Networks.SMIB.OpenLoopTests.NoiseOnLoad;
model SMIB_TM "Open-Loop Test of the Single-Shaft Gas Turbine Model driving generator of the SMIB network"
  extends
    Networks.SMIB.Partial.SMIB_Partial_Noise(
