within MicroGrid.Electrical.Networks.SMIB.NoiseOnLoad;
model SMIB_TurbGov2 "Model with GGOV1 turbine and ThermoPower PID controller, change of power dispatch"
  ...
  Controls.TG.GGOV1.Simplified.GGOV2B gGOV2B(
    R=0.04,
    T_pelec=1,
    maxerr=0.05,
    minerr=-0.05,
  ...
  Networks.SMIB.Records.PF_050 pf_results annotation (Placement(transformation(extent={{-136,50},{-116,70}})));
equation
