...
model Gen_GT "Generator without controls"
  ...
  Interfaces.TM2EPConverter tM2EPConverter
    annotation (Placement(transformation(extent={{-64,-16},{-32,16}})));
...
equation
  ...
  connect(generator.Pm0, Pm0) annotation (Line(points={{56.28,-17.64},{56.28,-57},{58,-57},{58,-106}}, color={0,0,127}));
  connect(speed, tM2EPConverter.SPEED) annotation (Line(points={{12,-60},{12,-38},{0,-38},{0,-8},{-33.6,-8}}, color={0,0,127}));
  connect(generator.PELEC, Pelec) annotation (Line(points={{31.44,-9.36},{20,-9.36},{20,-28}}, color={0,0,127}));
  annotation (
  ...
  Line(   points={{-48,2},{-20,56},{2,4},{24,-28},{48,22}},
          color={0,0,0},
          smooth=Smooth.Bezier),
  Text(   extent={{-52,-18},{56,-66}},
          lineColor={0,0,0},
          fillColor={255,255,255},
          fillPattern=FillPattern.Solid,
          textString="%name")}),
    Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{
          ...
          fillPattern=FillPattern.Solid,
          textString=
         "Generator (no AVR) with Interface for
