...
model Gen_AVR_PSS_GT "Generator + AVR + PSS"
  ...
  rotation=270,
  origin={54,-94})));
  Electrical.Generation_Groups.SMIB.Generator_AVR_PSS generator(
    M_b=M_b,
    V_b=V_b,
    v_0=v_0,
    angle_0=angle_0,
...
equation
  ...
  connect(generator.Pm0, Pm0) annotation (Line(points={{56.28,-17.64},{56.28,-57},{80,-57},{80,-106}}, color={0,0,127}));
  annotation (
    ...
    Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{
          ...
          fillPattern=FillPattern.Solid,
          textString=
         "Generator+AVR+PSS with Interface for
