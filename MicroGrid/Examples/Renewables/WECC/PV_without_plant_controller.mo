...
equation
  connect(REGC.V_t,controller. Vt) annotation (Line(points={{-6,12.8571},{-6,18},
          {-78,18},{-78,8.57143},{-75.625,8.57143}},
        color={0,0,127}));
  connect(REGC.Pgen,controller. Pe) annotation (Line(points={{0,12.8571},{0,22},
          {-82,22},{-82,4.28571},{-75.625,4.28571}}, color={0,0,127}));
  connect(REGC.Qgen,controller. Qgen) annotation (Line(points={{6,12.8571},{6,
          26},{-86,26},{-86,0},{-75.625,0}},
                      color={0,0,127}));
  connect(REGC.IP0,controller. IP00) annotation (Line(points={{-5.14286,
          -12.8571},{-5.14286,-16},{-35,-16},{-35,-13.7143}},color={0,0,127}));
  connect(REGC.IQ0,controller. IQ00) annotation (Line(points={{5.14286,-12.8571},
          {5.14286,-20},{-61,-20},{-61,-13.7143}},             color={0,0,
          127}));
  connect(controller.Iqcmd,REGC. Iqcmd) annotation (Line(points={{-21.1875,6},{
          -13.7143,6}},                                             color={
          0,0,127}));
  connect(controller.Ipcmd,REGC. Ipcmd) annotation (Line(points={{-21.1875,-6},
