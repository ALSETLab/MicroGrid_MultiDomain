...
model GAST
  ...
  OpenIPSL.Electrical.Controls.PSSE.TG.GAST gAST(
    R=0.05,
    T_1=0.4,
    T_2=0.1,
    T_3=3.0,
...
equation
  connect(iEEET1.EFD, gENROU.EFD) annotation (Line(points={{-81,-50},{
          -100,-50},{-100,-12},{-92,-12}},       color={0,0,127}));
  ...
  connect(gENROU.XADIFD, iEEET1.XADIFD) annotation (Line(points={{-46,-18},{-42,-18},{-42,-68},{-78,-68},{-78,-61}},
                                              color={0,0,127}));
  connect(gENROU.SPEED, gAST.SPEED) annotation (Line(points={{-46,14},{
          -42,14},{-42,44},{-62,44}},           color={0,0,127}));
  connect(gAST.PMECH, gENROU.PMECH) annotation (Line(points={{-81,50},{
          -100,50},{-100,12},{-92,12}},
                                  color={0,0,127}));
  connect(gENROU.PMECH0, gAST.PMECH0) annotation (Line(points={{-46,10},{
          -38,10},{-38,56},{-62,56}},              color={0,0,127}));
  connect(softPMU.p, gENROU.p) annotation (Line(points={{-27,42},{-36,42},
          {-36,0},{-48,0}}, color={0,0,255}));
  connect(softPMU.n, GEN1.p) annotation (Line(points={{-13,42},{-8,42},{
          -8,16},{-32,16},{-32,0},{-30,0}}, color={0,0,255}));
