within MicroGrid.Examples.MultiDomain.ThermalPowerPlants.Gas.ThermoPower.ThermoPowerPID.NoiseOnLoad;
model SMIB_Gov "Network model with no generator controls"
  import MicroGrid;
  import ThermoPower;
  extends Electrical.Networks.SMIB.Partial.SMIB_Partial_Noise(
  ...
  Thermal_Power.Gas.GTModels.ThPowerSSGT ssgt annotation (Placement(transformation(extent={{-118,-20},{-78,20}})));
  ...
  MicroGrid.MultiDomain.Generation_Groups.SMIB.Gen_GT genGroup(
    ...
    angle_0=pf_results.voltages.A1) annotation (Placement(
