within MicroGrid.Examples.MultiDomain.ThermalPowerPlants.Gas.ThermoPower.OpenLoopTests.NoiseOnLoad;
model SMIB_TM "Open-Loop Test of the Single-Shaft Gas Turbine Model driving generator of the SMIB network"
  ...
  Thermal_Power.Gas.GTModels.ThPowerSSGT ssgt
    annotation (Placement(transformation(extent={{-106,-14},{-78,14}})));
  ...
  Electrical.Networks.SMIB.Records.PF_030 pf_results
