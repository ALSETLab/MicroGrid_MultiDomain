...
model SMIB_Gov2 "Model with GGOV1 turbine and ThermoPower PID controller, change of power dispatch"
  ...
  MicroGrid.Electrical.Controls.TG.GGOV1.Simplified.PIDGovernor2A governor(
    R=0.04,
    T_pelec=1,
    maxerr=0.05,
    minerr=-0.05,
...
equation
  ...
  connect(genGroup.Pelec, governor.PELEC) annotation (Line(points={{-69,-5},
          {-80,-5},{-80,-58},{-92,-58},{-92,-58.1},{-92.9786,
          -58.1}},                                                color={0,0,127}));
  connect(genGroup.speed, governor.SPEED) annotation (Line(points={{-64,
          -9.8},{-64,-42},{-64,-41.9},{-92.9786,-41.9}},
                                                 color={0,0,127}));
  connect(add.y, governor.PSP) annotation (Line(points={{-66.6,
          -54},{-72,-54},{-72,-50},{-72,-50.1},{-92.9786,-50.1}},
                                                 color={0,0,127}));
  connect(gtDyns.shaft_b, genGroup.shaft) annotation (Line(points={{-90,0},{-90,0},{-70,0}}, color={0,0,0}));
  connect(governor.FSR, gtDyns.valvePosition) annotation (Line(points={{
          -121.114,-50},{-138,-50},{-138,9.5},{-130.3,9.5}},
                                                     color={0,0,127}));
  annotation (
