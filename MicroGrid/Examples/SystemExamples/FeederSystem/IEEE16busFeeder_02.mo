...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-360,
          ...
          extent={{-360,-460},{560,360}}), graphics={Text(
          extent={{790,464},{886,432}},
          lineColor={28,108,200},
          textString="- Add motors and substitute some loads for motors.
- Add the OpenIPSL Generator Models (version 02)
- Add Miguel's multi-doain gas turbine generator for version 03.
- Version 04 would have the motor with pump example.
- Add breakers and faults to the different feeders.")}),
    experiment(StopTime=10));
end IEEE16busFeeder_02;
