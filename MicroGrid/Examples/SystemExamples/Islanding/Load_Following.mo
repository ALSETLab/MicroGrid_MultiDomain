...
model Load_Following
  ...
  Optimization.CostFunction.OpenIPSL_Optimizer optimizer(
    costIntegrand_y=(SysData.fn - controller.freq)^2/(1000),
...
equation
  ...
  connect(GEN1.p, pwLine1.p) annotation (Line(points={{34,-30},{50,-30},
          {50,-19}}, color={0,0,255}));
  connect(pwLine1.n, bus.p) annotation (Line(points={{50,-1},{50,4},{-30,4},{-30,
          20},{-6,20}}, color={0,0,255}));
