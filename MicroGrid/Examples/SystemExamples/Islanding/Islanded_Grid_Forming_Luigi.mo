...
model Islanded_Grid_Forming_Luigi
...
equation
  ...
  connect(bus2.p, pwLine1.p)
    annotation (Line(points={{-6,50},{9,50}}, color={0,0,255}));
  connect(pwLine1.n, gENCLS1.p)
    annotation (Line(points={{27,50},{40,50}}, color={0,0,255}));
  connect(bus2.p, bus.p) annotation (Line(points={{-6,50},{-10,50},{-10,
...
end Islanded_Grid_Forming_Luigi;
