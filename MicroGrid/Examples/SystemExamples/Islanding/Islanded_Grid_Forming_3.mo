...
model Islanded_Grid_Forming_3
  ...
  Electrical.Renewables.PNNL.GridForming.GFMDRP_A controller(
    V_b=230,
    P_0=10000000,
    Q_0=45083300,
    v_0=0.978198,
  ...
  Optimization.MPComponents.Breaker breaker(t_o=10)
    annotation (Placement(transformation(extent={{-30,14},{-18,26}})));
equation
  ...
  connect(controller.Edroop, cVS.E_droop) annotation (Line(points={{-5.28571,
          -36},{-1,-36}}, color={0,0,127}));
  ...
  connect(cVS.p, GEN1.p)
    annotation (Line(points={{20,-30},{34,-30}}, color={0,0,255}));
  ...
  connect(GEN1.p, pwLine1.p) annotation (Line(points={{34,-30},{50,-30},
          {50,-19}}, color={0,0,255}));
  connect(pwLine1.n, softPMU.p) annotation (Line(points={{50,-1},{50,4},
          {0,4},{0,20},{9,20}},       color={0,0,255}));
  connect(bus1.p, pQ.p) annotation (Line(points={{54,20},{80,20},{80,0}},
        color={0,0,255}));
