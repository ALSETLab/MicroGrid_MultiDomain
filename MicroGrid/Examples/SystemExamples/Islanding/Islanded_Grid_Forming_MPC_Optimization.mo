...
model Islanded_Grid_Forming_MPC_Optimization
  ...
  Optimization.MPComponents.Breaker_MPC breaker_MPC
...
equation
  ...
  connect(CONT.u, controller.u1) annotation (Line(points={{-53,-10},{
          -50,-10},{-50,0},{-16,0},{-16,-18.5714}},
                                      color={0,0,127}));
  connect(CONT.dp_u, dp_u_opt) annotation (Line(points={{-76,-10},{-80,-10},{-80,
          -30},{-60,-30},{-60,-50},{-86,-50}}, color={0,0,127}));
  ...
  connect(gENCLS.p, breaker_MPC.s)
    annotation (Line(points={{-40,20},{-32,20}}, color={0,0,255}));
  connect(breaker_MPC.r, bus.p)
    annotation (Line(points={{-12,20},{-6,20}}, color={0,0,255}));
...
end Islanded_Grid_Forming_MPC_Optimization;
