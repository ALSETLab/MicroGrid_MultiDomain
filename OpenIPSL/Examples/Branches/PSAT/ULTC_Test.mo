...
model ULTC_Test
  ...
  Modelica.Blocks.Sources.Sine sine1(amplitude=0.001, f=0.2) annotation (
      Placement(transformation(origin={-92,10}, extent={{-4.4802,-4.4802},{
            4.4802,4.4802}})));
  ...
  Modelica.Blocks.Sources.Sine sine2(
    amplitude=0.001,
    f=0.2,
    startTime=5) annotation (Placement(transformation(origin={-92,-10}, extent=
            {{-4.4802,-4.4802},{4.4802,4.4802}})));
