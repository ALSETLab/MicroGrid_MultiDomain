...
model TGTypeVI_test
  ...
  Modelica.Blocks.Sources.Sine sine2(
    ...
    startTime=10,
    amplitude=-0.001,
    offset=0) annotation (Placement(transformation(origin={-26,-60}, extent={{6,
            -6},{-6,6}})));
  ...
  Modelica.Blocks.Sources.Sine sine1(
    ...
    startTime=5,
    amplitude=0.001,
    offset=1) annotation (Placement(transformation(origin={-26,-40}, extent={{
            6.00002,-6.00001},{-6,6.00001}})));
equation
