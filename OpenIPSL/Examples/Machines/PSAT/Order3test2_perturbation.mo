...
model Order3test2_perturbation
  ...
  Modelica.Blocks.Sources.Sine sine1(amplitude=0.001, f=0.2) annotation (
      Placement(transformation(origin={-95,20}, extent={{-5,-5},{5,5}})));
  ...
  Modelica.Blocks.Sources.Sine sine2(
    amplitude=0.001,
    f=0.2,
    startTime=5) annotation (Placement(transformation(origin={-95,5}, extent={{
            -5,-5},{5,5}})));
  Modelica.Blocks.Sources.Sine sine3(
    amplitude=0.001,
    f=0.2,
    startTime=10) annotation (Placement(transformation(origin={-95,-75}, extent=
           {{-5,-5},{5,5}})));
  ...
  Modelica.Blocks.Sources.Sine sine4(
    amplitude=0.001,
    f=0.2,
    startTime=5) annotation (Placement(transformation(origin={-95,-55}, extent=
            {{-5,-5},{5,5}})));
